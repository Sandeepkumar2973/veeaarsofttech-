...
function Digital() {
  ...
  <div className="container">
    ...
    <div className="col-lg-12 services-details">
      <div className="heading">
    <span className="arrow-icon"><MdCollectionsBookmark /></span>Key components of digital marketing include:
    </div>
      <ul typeof="">
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Search Engine Optimization (SEO): </strong>
        Optimizing online content to rank higher in search engine results, increasing organic (non-paid) traffic.</li>
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Content Marketing:</strong>
        Developing and disseminating beneficial, pertinent material to draw in and keep the target audience interested.
        Social Media.</li>
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Marketing: </strong>
        Utilizing social platforms like Facebook, Instagram, Twitter, and LinkedIn to connect and interact with followers.
        </li>
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Email Marketing:</strong>
        Sending personalized emails to boost leads, build consumer relationships, and advertise products or services. </li>
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Pay-Per-Click Advertising (PPC): </strong>
        Running paid advertising campaigns on platforms like Google Ads to drive traffic and conversions.
        </li>
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Affiliate Marketing: </strong>
        Partnering with affiliates or influencers to promote products and earn commissions for sales generated.
        </li>
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Online Public Relations (PR): </strong>
        Building and managing the online reputation of a brand or business.
       Analytics and Data Analysis: Collecting and analyzing data to measure the effectiveness of digital marketing efforts and make informed decisions.
        </li>
      </ul>
    </div>
    ...
    <div className="col-lg-12 services-details">
      <div className="heading">
    <span className="arrow-icon"><MdCollectionsBookmark /></span>Benefits of Digital Marketing:
    </div>
      <ul typeof="">
        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Increased Visibility and Reach : </strong>
        Digital marketing enables companies to expand their reach and connect with a broader audience. Through tactics such as search engine optimization (SEO), social media marketing (SMM), and content marketing, businesses can enhance their online visibility and attract potential customers who may have otherwise been out of reach. By optimizing their online presence, companies can ensure that they appear in relevant searches and engage with consumers across various digital channels.</li>

        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Targeted Marketing:</strong>
        One of the most significant advantages of digital marketing is its ability to target specific demographics, interests, and behaviors. Unlike traditional marketing methods that cast a wide net, digital marketing allows companies to tailor their messaging to resonate with their ideal audience segments. Through tools like Google Ads, Facebook Ads, and email marketing, businesses can deliver personalized content and offers that are more likely to convert, resulting in higher ROI and lower acquisition costs.
        </li>

        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Cost-Effectiveness: </strong>
        Digital marketing offers a cost-effective alternative to traditional advertising channels such as print, television, and radio. With digital marketing, companies can reach a larger audience at a fraction of the cost, making it accessible to businesses of all sizes and budgets. Additionally, digital marketing campaigns can be easily scaled up or down based on performance, allowing companies to allocate their marketing budgets more efficiently and maximize their return on investment.
       </li>

        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Measurable Results:</strong>
        Unlike traditional marketing methods, which can be challenging to track and measure, digital marketing provides real-time insights into campaign performance. Through analytics tools and metrics such as website traffic, conversion rates, and customer engagement, companies can monitor the effectiveness of their digital marketing efforts and make data-driven decisions to optimize their strategies for better results. This level of transparency and accountability enables companies to identify what’s working, what’s not, and where to allocate resources for maximum impact.
        </li>

        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Enhanced Customer Engagement and Loyalty: </strong>
        Digital marketing allows companies to engage with their customers in a more interactive and personalized manner. Through social media platforms, email newsletters, and online communities, businesses can foster meaningful relationships with their audience, encourage two-way communication, and build brand loyalty over time. By providing valuable content, addressing customer inquiries promptly, and offering personalized experiences, companies can create a loyal customer base that advocates for their brand and drives repeat business.
        </li>

        <li><strong><span className="arrow-icon"><FaArrowAltCircleRight /></span>Global Reach: </strong>
