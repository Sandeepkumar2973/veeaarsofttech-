...
function Aplication() {
  ...
  <div className="container">
    ...
    <img src="./../../assets/img/application-development.png" className="wow fadeInUp zoomOnHover" alt="image" style={{padding:"15px"}} />
</div>
...
<div className="col-lg-12 services-details">
    ...
    <img src="./../../assets/img/application-development.png-02.png" className="fadding" alt="image" style={{padding:"15px"}} />
    </div>
    <div className="col-lg-12 services-details">
