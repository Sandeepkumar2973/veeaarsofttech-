        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-12 services-details">
              <div className="services-details-desc">
                ...
                <p>
                  Blog4 marketing leverages platforms such as websites, search
          ...
          <div className="col-lg-12 services-details">
            ...
            <p style={{ textAlign: "center" }}>
              At our <strong>Blog4 Marketing Company in Delhi</strong>, we are
              committed to serving you the best in web development. Our team of
              skilled professionals brings your Blog4 vision to life, crafting
